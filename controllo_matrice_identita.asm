#Definita una matrice in memoria di N righe e N
#colonne con elementi halfword, ANxN, stampare in
#output il messaggio con la scritta IDENTITA' se 
#la matrice + la matrice identità o NON IDENTITA' 
#altrimenti. Una matrice identità è una matrice 
#costituita da elementi 0 eccetto quelli sulla diagonale
#principale che hanno valore 1
#ESEMPIO
#A
#1 0 0
#0 1 0
...
controllo_non_diagonale:
	...
	j non_id				#altrimenti vuol dire che non serve continuare
...
non_id:
	la $a0, sNot			#stampa la scritta per indicare che non è id
	li $v0, 4						
	syscall	
	j fine
